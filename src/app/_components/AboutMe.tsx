  ...
  return (
    <section className="py-section" id="about-me">
      <div className="container" ref={container}>
        ...
        <div className="mx-auto mt-9 grid max-w-[940px] items-center gap-10 md:grid-cols-12">
          <div className="md:col-span-6">
            <p className="slide-up-and-fade text-5xl">I&apos;m Guillaume.</p>
            <div className="mt-8 max-w-[390px] text-lg text-muted-foreground">
          ...
          <div className="md:col-span-6 md:flex md:justify-end">
            <div className="portrait-hover slide-up-and-fade group relative w-full max-w-[320px]">
              <span
                aria-hidden="true"
