...
const useGitHubLeaderboardState = () => {
...
const GitHubLeaderboardContent = ({
  activeTab,
  error,
  isLoading,
  repositories,
  ...
  const visibleRepositories = getSortedRepositories(
    repositories,
    activeTab,
  ).slice(0, 3);

  if (isLoading && !hasRepositories) {
    return (
